(function () {
  ...
  (function initGuaranteePopover() {
    ...
    var backdrop = document.getElementById("guarantee-backdrop");
    ...
    function setOpen(open) {
      if (open) {
        document.body.classList.add("is-guarantee-open");
        ...
        document.body.classList.remove("is-guarantee-open");
    ...
    document.addEventListener("click", function (e) {
      if (!isOpen()) return;
      var t = e.target;
      if (t && (trigger.contains(t) || popover.contains(t) || backdrop.contains(t))) return;
      setOpen(false);
    });

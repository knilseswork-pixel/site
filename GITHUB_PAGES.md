...
- Вкладка **«База элементов»** — статические/динамические элементы, ОФП, СФП и др.
- Вкладка **«Разделы»** в админке — редактирование полей (фото, описание, подводящие, ошибки, страховка, видео)
- **GitHub:** «Скачать content.json» и «Скачать sections.json» → заменить файлы в `data/`
